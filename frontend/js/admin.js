// Ye file administration controls dashboard scripts check handle karti hai.
// Isme total users counts mapping, database charts generation, edit/delete account checks, categories listings configurations register hain.
// Ye administrative view pages controllers data operations verify and draw karti hai.
  ...
  if (downloadPdfBtn) {
    downloadPdfBtn.addEventListener('click', async (e) => {
      ...
      try {
        ...
        const response = await authFetch(`${API_BASE_URL}/admin/reports/export-pdf`);
        ...
        a.href = url;
        a.download = 'admin_system_report.pdf';
        ...
        downloadPdfBtn.disabled = false;
        // Error toast will automatically be generated by authFetch
      }
    });
  }
