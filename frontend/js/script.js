// Ye file user-scope dashboard dynamic panels actions support handle karti hai.
// Isme transaction submit validation, Chart.js pie/bar charts drawing elements, list views pagination logic aur edit values sync set hai.
// Ye dashboard views and profiles update screens par dynamically load callbacks verify karti hai.
...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  // Programmatic download PDF report via authFetch
  ...
  if (downloadPdfBtn) {
    downloadPdfBtn.addEventListener('click', async (e) => {
      ...
      try {
        ...
        const response = await authFetch(`${API_BASE_URL}/transactions/export-pdf`);
        ...
        downloadPdfBtn.disabled = false;
        // Error toast will automatically be generated by authFetch or custom alert override
      }
    });
  }
